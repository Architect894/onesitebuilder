...
export default function SignupPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const firstName = data.user?.name?.split(" ")[0] || name.split(" ")[0] || "there";
            setLoading(false);
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center text-white px-6 overflow-hidden"
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="blob-drift-4 absolute inset-0" style={{
                ...
                <AnimatePresence mode="wait">
                    {success ? (
                        ...
                        >
                            ...
                            >
                                Your account is ready. Setting up your site&hellip;
                            </motion.p>
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="mt-4 inline-block px-3 py-1 bg-orange-500/20 border border-orange-400/40 rounded-full text-xs font-semibold text-orange-300"
                            >
